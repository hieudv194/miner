...
# ✅ **Yêu cầu Spot Instance**
echo "⏳ Đang yêu cầu Spot Instance..."
...
if [[ $spot_instance_id == *"error"* ]]; then
    echo "❌ Lỗi khi yêu cầu Spot Instance: $spot_instance_id"
else
    echo "✅ Đã yêu cầu Spot Instance: $spot_instance_id"
fi

echo "🎉 Hoàn thành khởi tạo EC2 tại $region!"
